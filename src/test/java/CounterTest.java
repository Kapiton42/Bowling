...
public class CounterTest {
    ...
    public void testCalculateScore() throws Exception {
        ...
        assertEquals("1", 30, Counter.calculateScore(data));
        data = new String[]{"x","x","x","00","x","12","00","00","00","00"};
        assertEquals("2", 76, Counter.calculateScore(data));
        data = new String[]{"1/","1/","12","00","00","1/","12","00","00","00"};
        assertEquals("3", 39, Counter.calculateScore(data));
        data = new String[]{"x","1/","12","1/","x","12","12","1/","12","1/x"};
        assertEquals("4", 107, Counter.calculateScore(data));
        data = new String[]{"x","x","x","x","x","x","x","x","x","xxx"};
        assertEquals("4", 300, Counter.calculateScore(data));
        data = new String[]{"10","10","10","10","10","10","10","10","10","100"};
        assertEquals("4", 10, Counter.calculateScore(data));
    }
}